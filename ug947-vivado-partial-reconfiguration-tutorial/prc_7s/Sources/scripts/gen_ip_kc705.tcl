...
#  prc_v1_0::get_property CONFIG.VS.vs_count.RM.rm_count_down.RESET_DURATION [get_ips $ip_name]
#  prc_v1_0::set_property CONFIG.VS.vs_count.RM.rm_count_down.RESET_DURATION 10 [get_ips $ip_name]
#  prc_v1_0::get_property CONFIG.VS.vs_count.RM.rm_count_down.RESET_DURATION [get_ips $ip_name]
#   
#   
#  # Example of using get_properties
#  prc_v1_0::get_properties  [get_ips prc]
